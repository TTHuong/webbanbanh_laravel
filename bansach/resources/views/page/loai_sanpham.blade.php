...
<div class="inner-header">
    <div class="container">
        <div class="pull-left">
            <h6 class="inner-title">Sản phẩm loại {{$loai_sp->name}}</h6>
        </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <ul class="aside-menu">
                        ...
                        @else
                        <li class="is-active"><a href="{{route('loaisanpham',$l->id)}}">{{$l->name}}</a></li>
                        @endif
                        @endforeach
                    </ul>
                </div>
                <div class="col-sm-9">
                    ...
                    <div class="beta-products-list">
                        ...
                        <div class="beta-products-details">
                            <p class="pull-left">Tìm thấy {{count($spk_theoloai)}} sản phẩm</p>
                            <div class="clearfix"></div>
                        </div>
                        <div class="row">
                            @foreach($spk_theoloai as $spk)
                            <div class="col-sm-4" style="margin-bottom: 10px;">
                                <div class="single-item">
                                    <div class="ribbon-wrapper">
